      ...
      >
        ...
        <Flex className="w-full grid grid-cols-2 md:flex md:w-auto">
          <Select
            ...
            displayValue={(value) =>
              getOptionByValue(memberStatusOptions, value as any)?.label
            }
          />
          ...
          <Select
            ...
            onChange={(row: any) => {
              setQueryParams({ role: row, page: 1 });
            }}
            getOptionValue={(option) => option?.value?.toLowerCase() as any}
            displayValue={(value) =>
              getOptionByValue(memberRolesOptions, value as any)?.label
            }
  ...
  },
  {
    label: (
      <Flex justify="start" className="gap-2">
        ...
        <Text>{TeamMemberStatus.Active}</Text>
      </Flex>
    ),
  ...
  },
  {
    label: (
      <Flex justify="start" className="gap-2">
        ...
        <Text>{TeamMemberStatus.Inactive}</Text>
      </Flex>
    ),
  ...
  },
  {
    label: (
      <Flex justify="start" className="gap-2">
        ...
        <Text>{TeamMemberStatus.Invited}</Text>
      </Flex>
    ),
