...
export default function Hero() {
  return (
    <>
      {/* <div  className="mb-[158px] md:mb-0 pt-20 3xl:pt-[6rem] lg:pb-5 3xl:pb-[177px] bg-full bg-top relative font-geist"> */}
      <div className="mb-[158px] md:mb-0 pt-20 3xl:pt-[6rem] lg:pb-5 3xl:pb-[177px] bg-full bg-top relative font-geist">
        {/* The map will be the background for the container */}
