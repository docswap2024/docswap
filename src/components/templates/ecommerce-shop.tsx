...
import {Dropdown, Button, ActionIcon, Drawer } from 'rizzui';
...
const filterParams = ['search', 'sort', 'order', 'page', 'type'];
    ...
    return (
        <Flex direction="col" align="stretch" className="gap-0">
            <Flex className="gap-6 mb-3 lg:mb-8 flex-col sm:flex-row" justify="start">
                <PageHeader
                title="Shop Files"
                description="Shop your files and folders from here"
            ...
            <Flex justify="start" direction="col" className="md:flex-row gap-3">
                ...
                <Flex
                className={cn(
                    'md:w-auto md:ml-auto gap-3 sm:mt-4 justify-end'
                )}
                >
            ...
            {breadcrumbs && (
                <Box className="mt-6">
                <Breadcrumbs breadcrumbs={breadcrumbs} manager={PAGES.DASHBOARD.SHOP}/>
                </Box>
            )}
            <Box className="mt-12">
                <ShopFoldersFiles
