...
export default function ContactUsView() {
  return (
    <Box className="font-geist mb-14 sm:mb-16 xl:mb-20">
      <header className="bg-[#141D25] font-geist relative w-full h-auto 3xl:aspect-[1920/840]">
        {/* <Image
        ...
        <Container className="max-w-[120rem] relative z-[3] px-4 h-full md:px-8 3xl:px-40 ">
          ...
          >
            ...
            Making Real Estate <br className="hidden xl:inline" />  More Productive
              <br className="xl:hidden" /> And
              <br className="hidden xl:inline" /> Profitable
            </Title>
            <Text className="max-w-[300px] md:max-w-[400px] lg:max-w-[500px] xl:max-w-[530px] lg:text-base xl:text-xl leading-normal">
              Let us know how we can improve your business.
            </Text>
          </Flex>
        </Container>
      </header>
